...
use crate::{
    ...
    features::extended_connect::{
        ...
        send_group::Id as SendGroupId, stats::WebTransportSessionStats,
    },
    frames::HFrame,
...
impl Session {
    ...
    #[must_use]
    pub(crate) fn stats(&self, now: Instant) -> Option<WebTransportSessionStats> {
...
pub(crate) trait Protocol: Debug + Display {
    ...
    fn stats(&self, _now: Instant) -> Option<WebTransportSessionStats> {
        None
    }
